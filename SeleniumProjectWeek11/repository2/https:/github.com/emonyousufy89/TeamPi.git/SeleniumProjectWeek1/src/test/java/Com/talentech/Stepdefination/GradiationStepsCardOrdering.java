...
//
//public class GradiationStepsCardOrdering {
//	
//	public WebDriver driver;
//	public GraduationPagesCardOrdering Grad;
//	
////	@Given("Customer is on Homepage")
////	public void customer_is_on_Homepage() {
////		GraduationPagesCardOrdering gr1= new GraduationPagesCardOrdering();
////	    gr1.Show();
////	}
//
////	@Given("Customer Mouse Hover on Mail&Ship")
////	public void customer_Mouse_Hover_on_Mail_Ship() {
////		GraduationPagesCardOrdering gr2= new GraduationPagesCardOrdering();
////		gr2.MailShip();
////	}
////
////	@When("Customer sees a drop down menu")
////	public void customer_sees_a_drop_down_menu() {
...
//	}
//
//	@And("Customer clicks on Cards & Envelope")
...
//	}
//
//	@And("Cutomer Selects Graduation from the left filter options")
...
//	}
//
//	@And("Customer Selects Flowers From The Garden Notecards")
...
//	}
//
//	@And("Customer Lands on Checkout page")
//	public void customer_Lands_on_Checkout_page() {
//	    System.out.println("go now");
//	}
//
//	@And("Customer Clicks on the add to cart option")
//	public void customer_Clicks_on_the_add_to_cart_option() {
